...
class Donor(object):
    ...
    def generate_report_row(self):
        ...
        return report_fmt_str.format(self.donor_name, self.num_donations, self.total_donations, self.avg_donation)
    ...
    def generate_text(self):
        ...
        outlines.append(fmtline2.format(self.total_donations, self.avg_donation))
...
class DonorCollection(object):
    ...
    def generate_report_all(self):
        ...
        header1 = header_fmt_str.format('Name', 'Num', 'Total', 'Average')
        header2 = header_fmt_str.format('', 'Donations', 'Donations', 'Donation')
