...
donors_dict = {'Aron King': [1, 2], 'Becky Patty': [3000, 1000], 'Charlie Lee': [666, 222],
               'Thomas Dave':[202, 90, 450], 'Nancy Crow': [100, 200, 300]}
...
def create_report():
    ...
    print("{:<20}{:<15}{:<15}{:^15}".format('Donors-name', 'Total', 'Num gifts', 'Average gift'))
    print('_ ' * 30)
    for a, b, c, d in list_sorting:
        print("{:<20} ${:<15.2f}{:<15}${:<15.2f}".format(a,b,c,d))
    print('_ ' * 30); print('End of Report\n')
