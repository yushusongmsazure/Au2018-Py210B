...
def test_render_element():
    ...
    # Check that there is only one open and close html tag
...
def test_title():
    """
    tests single-line elements like Title
    """
...
def test_indent():
    ...
    file_contents = render_result(html, ind=0).rstrip()  #remove the end newline
